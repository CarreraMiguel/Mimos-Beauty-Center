...
export class HomeComponent {
  ...
  { author: 'Sofía Gabián', imageUrl: 'assets/img/estrellas.png', text: 'La super recomiendo. No puedo estar más feliz con el resultado, unas uñas preciosas y sin ninguna molestia.Evelyn es un amor, cuida cada detalle, super delicada, muy agradable atenta. Volveré sin dudarlo 🥰' }
];

  visibleReviews = this.reviews.slice(0, 3);
  currentIndex = 0;
